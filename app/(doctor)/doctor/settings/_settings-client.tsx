...
export default function SettingsClient({
  ...
  initialClinic:  DoctorClinicData  | null;
}) {
  const router = useRouter();
  const [tab,     setTab]     = useState<Tab>("profile");
  const [profile, setProfile] = useState<DoctorProfileData | null>(initialProfile);
  const [clinic,  setClinic]  = useState<DoctorClinicData  | null>(initialClinic);
...
function ClinicTab({
  ...
  const [form, setForm] = useState<DoctorClinicData>(initialData ?? defaultForm);
