      ...
      <div className="fixed inset-y-0 right-0 z-50 flex w-full max-w-sm flex-col border-l border-border bg-card shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-border/60 px-5 py-4">
          <div className="flex items-center gap-3">
            <div className="flex size-9 items-center justify-center rounded-xl bg-vault-positive-light">
              <Receipt className="size-4 text-vault-positive" />
            </div>
            <div>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
          ...
          <div className="rounded-xl border border-border bg-muted/20 p-4">
            <div className="flex items-center justify-between mb-3">
              <span
                className="inline-flex items-center gap-1.5 rounded-full bg-vault-positive-light px-2.5 py-0.5 text-[10px] font-semibold text-vault-positive"
              >
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                { icon: <Receipt className="size-3.5" />,  label: "Service",  value: invoice.type },
                { icon: <Receipt className="size-3.5" />,  label: "Provider", value: "Dr. Jack — Family Medicine" },
                { icon: <Calendar className="size-3.5" />, label: "Date",     value: invoice.date },
                { icon: <Clock className="size-3.5" />,    label: "Time",     value: invoice.time },
                { icon: <MapPin className="size-3.5" />,   label: "Location", value: invoice.location },
          ...
          <div>
            ...
            <div className="rounded-xl border border-border overflow-hidden">
              <div className="flex items-center justify-between px-4 py-3 text-sm">
                ...
                <span className="tabular-nums font-medium text-foreground">${invoice.amount}.00</span>
              </div>
              <div className="flex items-center justify-between border-t border-border/60 bg-muted/20 px-4 py-3 text-sm font-semibold">
                ...
                <span className="tabular-nums text-foreground">${invoice.amount}.00</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 rounded-xl border border-border bg-muted/20 px-4 py-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground">Charged on {invoice.date}</p>
              </div>
            </div>
          </div>
        </div>
