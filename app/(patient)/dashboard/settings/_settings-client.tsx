...
export default function SettingsClient({
  ...
  const refreshProfile = () => { router.refresh(); };
...
function ProfileTab({
  ...
  return (
    <div className="space-y-4">
      <PersonalInfoCard profile={profile} email={email} initials={initials} onSaved={onSaved} />
      <MedicalProfileCard profile={profile} onSaved={onSaved} />
      <EmergencyContactCard profile={profile} onSaved={onSaved} />
    </div>
  );
}
